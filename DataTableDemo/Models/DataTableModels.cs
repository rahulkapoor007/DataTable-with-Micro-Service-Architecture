...
namespace DataTableDemo.Models
{
    ...
    public class DTParameters
    {
        ...
        public IEnumerable<string> AdditionalValuesPipelineName { get; set; }

        public bool IsGenericSearch { get; set; }
        public string RequestedFilterColumn { get; set; }
        public string RequestedFilterColumnIndex { get; set; }
        public DateTime? StartDate { get; set; }
        public DateTime? EndDate { get; set; }
        public DateTime? GeneratedStatementDate { get; set; }
        public int Id_Val { get; set; }
        public int DataSet_Id { get; set; }
        public string MeterID { get; set; }
        public string PipeDuns { get; set; }
        public DateTime? CreatedDate { get; set; }
        public bool IsNonPathed { get; set; }
